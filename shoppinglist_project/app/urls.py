...
urlpatterns = [
    ...
    path('store/<int:store_id>/category/<int:pk>/delete/', views.category_link_delete, name='category_link_delete'),
    path('category/<int:pk>/delete/', views.category_master_delete, name='category_master_delete'),
